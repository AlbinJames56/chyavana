...
@section('content')
    ...
    <section class="relative py-32 mt-20">
        ...
        <div class="absolute inset-0">
            <img src="/images/bg-4.jpg" class="w-full h-full object-cover opacity-40">
        </div>
        ...
        <div class="relative container mx-auto text-center max-w-3xl px-6 text-white space-y-8">
            ...
            <h1 class="mt-6 text-5xl md:text-6xl font-bold text-gray-900 leading-tight" data-aos="fade-up">
