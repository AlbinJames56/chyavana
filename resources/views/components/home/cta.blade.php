<section id="contact-cta" class="py-8 md:py-20 bg-[var(--primary-green)] text-white">
    <div class="container  px-8 md:px-14 lg:px-28   mx-auto text-center" data-aos="fade-up">
        <div class="max-w-3xl mx-auto">
            <h2 class="text-4xl lg:text-5xl mb-6 text-white" style="font-family: var(--font-body); font-weight: 700;">
                Ready to Begin Your Healing Journey?
            </h2>
            <p class="text-xl text-white/70 mb-8" style="font-family: var(--font-body);">
                Schedule your initial consultation and discover how Ayurveda can transform your health naturally and
                holistically.
            </p>
