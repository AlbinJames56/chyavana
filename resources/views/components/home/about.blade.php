    ...
    <div class="container    px-8 md:px-14 lg:px-28   mx-auto ">
        <div class="grid lg:grid-cols-2 gap-12 items-center ">
            <div data-aos="fade-right">
                <h2 class="text-4xl lg:text-5xl text-[var(--neutral-dark)] mb-6"
                ...
                <p class="text-lg text-[var(--muted-foreground)] mb-6" style="font-family: var(--font-body);">
                    At Chyavana Ayurveda Hospital, we combine ancient Ayurvedic wisdom with modern medical
                    understanding to provide comprehensive healthcare solutions. Our experienced practitioners are
                    dedicated to identifying root causes and promoting lasting wellness through natural, personalized
                    treatments.
                </p>
                <p class="text-lg text-[var(--muted-foreground)] mb-8" style="font-family: var(--font-body);">
                    Whether you're seeking relief from chronic pain, managing a health condition, or simply looking
