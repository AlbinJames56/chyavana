<section id="why-us"
    class="py-8 md:py-20 bg-gradient-to-br from-[var(--primary-green)] to-[var(--primary-green --)]/80 text-white">
    <div class="container  px-8 md:px-14 lg:px-28   mx-auto ">
        <div class="text-center max-w-3xl mx-auto mb-16" data-aos="fade-up">
            ...
            <p class="text-lg text-white/70" style="font-family: var(--font-body);">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div data-aos="fade-up" data-aos-delay="100">
                <x-cards.feature-card title="Certified Practitioners"
            ...
            <div data-aos="fade-up" data-aos-delay="200">
                <x-cards.feature-card title="Natural Healing"
                    ...
                    <x-slot:icon>
                        ...
                        <svg class="w-8 h-8 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path
                                d="M11 3a8.5 8.5 0 0 0-8 8.5C3 15.5 5.5 19 9.5 19A8.5 8.5 0 0 0 18 10.5C18 5.5 14.5 3 11 3z" />
                            <path d="M11 3v13" />
                        </svg>
                    </x-slot:icon>
                </x-cards.feature-card>
            ...
            <div data-aos="fade-up" data-aos-delay="300">
                <x-cards.feature-card title="Personalized Care"
            ...
            <x-cards.feature-card title="Proven Results"
