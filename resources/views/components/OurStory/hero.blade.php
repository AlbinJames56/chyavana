<section class="relative py-16 md:py-28 mt-12 md:mt-0 overflow-hidden">
  ...
  <div class="absolute inset-0 bg-gradient-to-br from-[var(--primary-green)]/5 via-white to-[var(--primary-green)]/10">
  </div>
  ...
  <div class="container mx-auto px-8 md:px-14 lg:px-28 relative z-10">
    <div class="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div class="space-y-6" data-aos="fade-right">
        ...
        <!-- Body text -->
        <p class="  text-[var(--muted-foreground)] max-w-xl leading-relaxed" style="font-family:var(--font-body)">
      ...
      <div class="relative" data-aos="fade-left">
        ...
        <div
          class="absolute inset-0 rounded-3xl border border-[var(--primary-green)]/20 scale-100 translate-x-3 translate-y-3">
        </div>

        <img
          src="https://images.unsplash.com/photo-1760696473939-88db0835c908?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080"
          alt="Ayurvedic herbs and healing" class="w-full h-[520px] object-cover rounded-3xl shadow-xl">

        <!-- Floating organic badge -->
        <div
          class="absolute bottom-6 left-6 bg-white/80 backdrop-blur-md border border-[var(--border)] rounded-xl p-5 shadow-md">
          <div class="flex items-center gap-4">
