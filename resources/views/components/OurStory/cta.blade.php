<section class="py-12 md:py-20 bg-[var(--primary-green)] text-white">
  <div class="container mx-auto mx-auto px-8 md:px-14 lg:px-28 text-center">
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
     <button type="button" onclick="window.dispatchEvent(new CustomEvent('open-booking'))"  class="bg-white text-[var(--primary-green)] px-6 py-3 rounded-lg inline-flex items-center gap-2">
        Book Consultation
        <i class="fa-solid fa-arrow-right"></i>
</button>

      <a href="/OurHealers" class="border border-white text-white px-6 py-3 rounded-lg inline-flex items-center gap-2 hover:bg-white/10">
        Meet Our Healers
      </a>
    </div>
  </div>
