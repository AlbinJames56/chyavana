<section class="py-16 bg-[var(--neutral-light)]">
  <div class="container mx-auto px-8 md:px-14 lg:px-28">
    ...
    <div class="text-center max-w-2xl mx-auto mb-12">
      <span class="inline-block px-4 py-1 rounded-full bg-[var(--primary-green)]/10 text-[var(--primary-green)] text-sm font-semibold">
    ...
    <div class="max-w-4xl mx-auto">
      <div class="bg-white rounded-3xl border border-[var(--border)] shadow-md overflow-hidden">
